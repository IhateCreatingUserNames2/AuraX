...
class UserRepresentation(BaseModel):
    user_id: str
    name: str = "User"
    emotional_state: str = "neutral"  # Detectado na última interação
    communication_style: str = "neutral" # formal, direct, casual
    knowledge_level: str = "unknown" # beginner, expert
